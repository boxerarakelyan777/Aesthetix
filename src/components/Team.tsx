...
const TeamMember: React.FC<TeamMemberProps> = ({ name, title, description, imgSrc, linkedIn, github, twitter }) => {
  return (
    <div className="bg-teal-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 flex flex-col items-center text-center">
      <Image
        ...
        height={200}
      />
      <h3 className="text-2xl font-semibold mb-2 text-yellow-400">{name}</h3>
      <span className="text-lg font-light text-white mb-4">{title}</span>
      <p className="text-base mb-6 text-gray-300">{description}</p>
      <ul className="flex justify-center space-x-4">
        <li>
          <a href={linkedIn} target="_blank" rel="noopener noreferrer" className="block p-1 rounded-full bg-gradient-to-r from-teal-400 to-teal-600 hover:from-yellow-400 hover:to-teal-400 transition-all duration-300">
        ...
        <li>
          <a href={github} target="_blank" rel="noopener noreferrer" className="block p-1 rounded-full bg-gradient-to-r from-teal-400 to-teal-600 hover:from-yellow-400 hover:to-teal-400 transition-all duration-300">
            <svg className="w-6 h-6 fill-white" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fillRule="evenodd"
        ...
        <li>
          <a href={twitter} target="_blank" rel="noopener noreferrer" className="block p-1 rounded-full bg-gradient-to-r from-teal-400 to-teal-600 hover:from-yellow-400 hover:to-teal-400 transition-all duration-300">
            <svg className="w-6 h-6 fill-white" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fillRule="evenodd"
